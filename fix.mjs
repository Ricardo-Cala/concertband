...
// ============ Avatar.jsx ============
const avatarCode = `export default function Avatar({ amigo, size = 34 }) {
...
writeFileSync('src/components/Avatar.jsx', avatarCode)
console.log('✔ src/components/Avatar.jsx actualizado')

// ============ Grupo.jsx ============
const grupoCode = `import { useState, useRef } from 'react'
...
`
writeFileSync('src/components/Grupo.jsx', grupoCode)
console.log('✔ src/components/Grupo.jsx actualizado (Fase 3A)')
